...
from public.llmcloud.requestmanager.v1 import requestmanager_pb2 as public_dot_llmcloud_dot_requestmanager_dot_v1_dot_requestmanager__pb2
...
class RequestManagerService(object):
    ...
    @staticmethod
    def GetTextCompletionStream(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/public.llmcloud.requestmanager.v1.RequestManagerService/GetTextCompletionStream',
    ...
    def GetTextCompletion(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/public.llmcloud.requestmanager.v1.RequestManagerService/GetTextCompletion',
            public_dot_llmcloud_dot_requestmanager_dot_v1_dot_requestmanager__pb2.GetTextCompletionRequest.SerializeToString,
